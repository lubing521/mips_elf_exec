...
static ngx_uint_t   ngx_show_help = 0;
static ngx_uint_t   ngx_show_version = 0;
static ngx_uint_t   ngx_show_configure = 0;
static u_char      *ngx_prefix = "/";
static u_char      *ngx_conf_file = NGX_CON_FILE;
static u_char      *ngx_conf_params = NULL;
static char        *ngx_signal = NULL;

static char **ngx_os_environ = NULL;
...
*/
    cycle->log->log_level = NGX_LOG_INFO; // tangyoucan
    return NGX_OK;
}
